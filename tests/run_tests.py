...
def check_prerequisites():
    ...
    print(
        f"{'✓' if together_available else '⚠'} TOGETHER_API_KEY: {'Set' if together_available else 'Not set'}"
    )
    ...
    try:
        ...
        print(
            f"{'✓' if ollama_available else '⚠'} Ollama service: {'Running' if ollama_available else 'Not running'}"
        )
    except:
