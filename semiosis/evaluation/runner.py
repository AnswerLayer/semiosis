...
from semiosis.agents.base import AgentState, BaseAgent
...
class EvaluationRunner:
    ...
    def run_evaluation(self) -> Dict[str, Any]:
        ...
        for i, task in enumerate(tasks):
            ...
            if self.context_system:
                ...
                context_string = self.context_system.get_context_string(
                    context_elements
                )
    ...
    def _compile_results(self) -> Dict[str, Any]:
        ...
        avg_score = (
            sum(r["evaluation"].score for r in self.results) / total_tasks
            if total_tasks > 0
            else 0
        )
        ...
        return {
            ...
            "metadata": {
                ...
                "context_system_type": (
                    self.context_system.__class__.__name__
                    if self.context_system
                    else None
                ),
